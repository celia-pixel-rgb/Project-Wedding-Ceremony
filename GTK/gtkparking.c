...
static void on_guest_check(GtkButton *btn, gpointer data) {
     ...
     * misleading "spot not available" message when the real issue is that
     * the guest already has a booking.  The confirm stage issues the
     * correct, specific error in that case.                                */
